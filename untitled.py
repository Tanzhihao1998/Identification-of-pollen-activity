...
"background-color: rgb(106, 255, 251);")
    ...
    def doTest(self):
        ...
        parser.add_argument('--source', type=str, default='0', help='source 0')  # file/folder, 0 for webcam
        ...
        for path, img, im0s, vid_cap in dataset:
            ...
            for i, det in enumerate(pred):  # detections per image
                ...
                s += '%gx%g ' % img.shape[2:]  # print string 图像大小
                ...
                if len(det):
                    ...
                    for c in det[:, -1].unique():
                        ...
                        s += f"{n} {names[int(c)]}{'s' * (n > 1)}, "  # add to string  类别及个数
                        for v in s,:
